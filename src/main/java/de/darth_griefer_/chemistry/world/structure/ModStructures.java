package de.darth_griefer_.chemistry.world.structure;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;
import de.darth_griefer_.chemistry.Chemistry;
import de.darth_griefer_.chemistry.world.structure.structures.alabStructure;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, Chemistry.MOD_ID);
    
    public static final RegistryObject<Structure<NoFeatureConfig>> ALAB = 
            STRUCTURES.register("alab", alabStructure::new);
    
    public static void setupStructures(){
        setupMapSpacingAndLand(ALAB.get(),
