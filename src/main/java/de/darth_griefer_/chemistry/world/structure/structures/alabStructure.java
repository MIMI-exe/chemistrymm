package de.darth_griefer_.chemistry.world.structure.structures;
...
public class alabStructure extends Structure<NoFeatureConfig> {
    public alabStructure() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return alabStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(Chemistry.MOD_ID, "alab/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "alab at " +
